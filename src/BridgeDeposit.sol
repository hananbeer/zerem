...
contract BridgeDeposit {
    ...
    constructor(
        ...
        ZeremFactory zeremFactory = new ZeremFactory();

        zerem = zeremFactory.deploy(address(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE),_minLockAmount, _unlockDelaySec, _unlockPeriodSec);
        owner = msg.sender;
